...
export default function Example() { 
  return (
    <MDBContainer fluid className="py-5 gradient-custom" >
      <div className="homeExam" style={{display:'flex'}
      }>
        <div  className="col-mb-4 mb-md-0" style={{color:'black'}}>
              ...
              <MDBTypography listUnStyled className="mb-0">
                ...
                <li className="p-2 border-bottom">
                  ...
                  >
                    ...
                    <div className="pt-1">
                      <p className="small text-blacks mb-1">5 mins ago</p>
                    </div>
                  </a>
                </li>
                <li className="p-2 border-bottom">
        ...
        <div >
          <div  className="text-black chatComponent" >
